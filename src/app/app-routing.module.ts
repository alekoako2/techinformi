...
const appRoutes: Routes = [
  ...
  },
  {
    path: 'about-us', loadChildren:
      () => import( './modules/pages/about-us/about-us.module')
        .then(mod => mod.AboutUsModule)
  },
  {
    path: 'account', loadChildren:
      () => import( './modules/pages/account/account.module')
        .then(mod => mod.AccountModule)
  },
  {
    path: 'contact', loadChildren:
      () => import( './modules/pages/contact/contact.module')
        .then(mod => mod.ContactModule)
  },
  {
    path: 'faq', loadChildren:
      () => import( './modules/pages/faq/faq.module')
        .then(mod => mod.FaqModule)
  },
  {
    path: 'partnership', loadChildren:
      () => import( './modules/pages/partnership/partnership.module')
        .then(mod => mod.PartnershipModule)
  },
  {
    path: 'services', loadChildren:
      () => import( './modules/pages/services/services.module')
        .then(mod => mod.ServicesModule)
  },
  {
    path: 'qrj', loadChildren:
  ...
  },
  {
    path: 'publications', loadChildren:
      () => import( './modules/pages/publications/publications.module')
        .then(mod => mod.PublicationsModule)
  },
  {
    path: 'scientific-activity', loadChildren:
      () => import( './modules/pages/scientific-activity/scientific-activity.module')
        .then(mod => mod.ScientificActivityModule)
  }
];
