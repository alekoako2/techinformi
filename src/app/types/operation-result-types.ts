...
export interface QrjPublicationsQuery_qrjPublications_journal {
  code: string | null
  translation:
    | (QrjPublicationsQuery_qrjPublications_journal_translation | null)[]
    | null
}
...
export interface QrjPublicationsQuery_qrjPublications_oecd {
  code: string | null
  translation:
    | (QrjPublicationsQuery_qrjPublications_oecd_translation | null)[]
    | null
}
...
export interface QrjPublicationsQuery_qrjPublications {
  ...
  translation:
    | (QrjPublicationsQuery_qrjPublications_translation | null)[]
    | null
}
...
export interface ResearchProjectsQuery_researchProjects_oecds {
  code: string | null
  translation:
    | (ResearchProjectsQuery_researchProjects_oecds_translation | null)[]
    | null
}
...
export interface ResearchProjectsQuery_researchProjects {
  ...
  pincode: string | null
  translation:
    | (ResearchProjectsQuery_researchProjects_translation | null)[]
    | null
